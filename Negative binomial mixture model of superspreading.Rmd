...
#  geom_point(aes(x = Cases, y = Proportion, colour=Model))+
  geom_point(aes(x = Cases, y = Proportion, shape=Model, colour=Model), alpha=1)+
...
CompCumuDistplot<-
ggplot(clusterdistrib)+
  geom_point(aes(x = Chains, y = CompCumuProb, shape=Model, colour=Model), alpha=1)+
...
#ggsave("Figure7.pdf", majoroutbreakplot, height=4, width=5)
```
...
ggplot(controlstat)+
  ...
  ylab("Extinction Probability")+xlab("Control level c")
ggsave("Figure8.pdf", extplot, height=4, width=5)
```
```{r}
varmeanplot<-
ggplot(controlstat)+
  ...
  ylab("Variance to mean ratio")+xlab("Control level c")
ggsave("Figure9.pdf", varmeanplot, height=4, width=5)
```
```{r}
ggplot(controlstat)+
...
```
```{r}
changeplot<-ggplot(controlstat)+
   geom_point(aes(x = Control, y = MajorOutbreakPercentageChange, colour=Model))+
  geom_line(aes(x = Control, y = MajorOutbreakPercentageChange, colour=Model))+
  ylab("Percentage change in probability of major outbreak")+xlab("Control level c")
ggsave("Figure10.pdf", changeplot, height=4, width=5)
```

```{r}
#library(cowplot)

#iris1 <- ggplot(controlstat)+
 #  geom_point(aes(x = Control, y = ExtinctionProbability, colour=Model))+
#  geom_line(aes(x = Control, y = ExtinctionProbability, colour=Model))

#iris2 <- ggplot(controlstat)+
#   geom_point(aes(x = Control, y = MajorOutbreakPercentageChange, colour=Model))+
#  geom_line(aes(x = Control, y = MajorOutbreakPercentageChange, colour=Model))
