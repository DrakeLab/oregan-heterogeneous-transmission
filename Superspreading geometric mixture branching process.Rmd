...
for(i in 1:length(clusterM) )clusterM[i]<-clusterGeometricmixture(6, p=0.8, R0D=1.5, R0A=5)
...
extprobM<-uniroot(GeometricMixtureGen, c(0, 0.99),  p=0.8, R0D=1.5, R0A=5)$root
...
csize22<-fNrGeo(2, 1, p2, R0D2, R0A2)*gNGeo(1,p2,R0D, R0A2)/2
