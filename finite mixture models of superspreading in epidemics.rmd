---
title: 'Finite mixture models of superspreading in epidemics: code and figures'
...
ggsave("pmfplot.pdf", pmfplot, height=9, width=14.5, units="cm") ##Figure 2
pmfplot
```
...
ggsave("pgfplot.pdf", pgfplot, height=9, width=14.5, units="cm") ###Figure 3
pgfplot
...
ggsave("compcdfplot.pdf", CompCumuDistplot, height=9, width=14.5, units="cm") ###Figure 4
CompCumuDistplot
...
meanchainplot
```
\textbf{Figure.}  Mean chain sizes are largest for large dispersion parameter $k$, small $p$ and large number of additional contacts. Mean chain sizes decrease as $p$ increases and approaches the value of the standard model as $p$ approaches 1. Mean chain sizes are larger in mixture models compared to the base model, even if $k>1$.
...
Key statistics generated by base model with $k=2$ and mixture model with 10\% superspreaders (row of Table 2 in text)
```{r}
...
ggsave("controlplot.pdf", controlplot, height=13, width=14.5, units="cm")###Figure 5
```
